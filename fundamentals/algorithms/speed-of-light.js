...
console.log('SPACE(speedOfLight): ', speedOfLight) // 299 792 458 m/s
console.log('SPACE(gravity): ', gravity) // 0

function earth() { // Function Scope
    var gravity = '9.8 m/s2' // function Scope (initialize a new variable that only applies to the function)
    var temperature = '24C'
